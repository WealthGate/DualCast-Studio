...
export const installDevelopmentBridge = () => {
  ...
  window.dualcast = {
    ...
    getUpdateStatus: async () => ({ state: "idle", currentVersion: "0.5.0" }),
    checkForUpdates: async () => ({ state: "idle", currentVersion: "0.5.0", message: "Update checks run in the installed desktop app." }),
