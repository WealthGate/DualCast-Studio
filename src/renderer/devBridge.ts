...
export const installDevelopmentBridge = () => {
  ...
  window.dualcast = {
    ...
    beginRecording: async () => { throw new Error("Recording is available in the Electron desktop app."); },
    appendRecordingChunk: async () => false,
    finishRecording: async () => { throw new Error("Recording is available in the Electron desktop app."); },
    cancelRecording: async () => false,
    ...
    sendStreamChunk: async () => false,
    getStreamLogPath: async () => null,
    getStreamLogContent: async () => "",
    getStreamingCapabilities: async () => ({ encoders: ["x264"], secureStorageAvailable: false }),
    ...
    listScriptureLibraries: async () => [],
    lookupScriptureLibrary: async ({ reference }) => ({ reference, text: "Development preview: offline Scripture libraries run in the Electron desktop app." }),
    importScriptureLibrary: async () => null,
    downloadScriptureLibrary: async () => { throw new Error("Scripture library downloads run in the Electron desktop app."); },
    saveScripturePassage: async () => ({ id: "saved-passages", name: "Saved Passages", passageCount: 1, savedPassages: true }),
    removeScriptureLibrary: async () => false,
    getScriptureLibraryCatalog: async (libraryId) => ({ libraryId, books: [] }),
    listSongs: async () => [],
    importSong: async () => null,
